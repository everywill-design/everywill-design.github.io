...
(function () {
  ...
  var FAQ_DATA = [
    ...
    },
    {
      ...
      answer: "公式LINEから、お名前・ご住所などの登録とeKYC（オンライン本人確認）が必要です。本人確認書類として、例えばマイナンバーカードや運転免許証等をご用意いただくとスムーズです。会員登録時にはデジタル庁の仕組みも導入しているので安心です。<br><a href=\"register.html\">→ 会員登録・使い方の詳細</a>",
      keywords: ["登録に必要なもの", "ekyc", "本人確認", "本人確認書類", "免許証", "マイナンバー", "必要なもの", "必要書類"]
    },
    {
      category: "料金・登録",
    ...
    },
    {
      category: "料金・登録",
      question: "退会したい",
      answer: "トリイクのマイページから退会手続きが可能です。公式LINEのメニューからマイページにアクセスし、退会のお手続きをお願いします。",
      keywords: ["退会したい", "退会方法", "解約したい", "やめたい", "マイページ 退会"]
    },
    {
      category: "料金・登録",
      question: "登録したい住所と本人確認書類の住所が違います（単身赴任など）",
      answer: "本人確認は、書類に記載されたご住所での登録が必要です。まずは本人確認書類どおりのご住所で会員情報をご登録ください。単身赴任などで実際にお住まいの場所が異なる場合は、公式LINEのチャットからご事情をお知らせください。個別に対応いたします。<br><a href=\"https://page.line.me/301wzhhp?oat__id=6771964&openQrModal=true\" target=\"_blank\" rel=\"noopener\">→ LINEで問い合わせる</a>",
      keywords: ["単身赴任", "住所が違", "住所が異な", "現住所", "登録住所", "書類の住所", "住所を変更", "引っ越し", "引越し"]
    },
    {
      category: "料金・登録",
      question: "本人確認にパスポートは使えますか？",
      answer: "ご利用いただけます。ただし2020年2月4日以降に発行されたパスポートには住所の記載欄がないため、ご住所を確認できる書類を1点あわせてご提出ください。<br>【対象となる書類（いずれか1点・発行から6ヶ月以内）】<br>・住民票の写し（マイナンバーの記載がないもの）<br>・公共料金の領収書または請求書（電気・ガス・水道・NHK・固定電話。携帯電話は対象外です）<br>・国税または地方税の領収書、納税証明書<br>いずれも、お名前とご住所がトリイクのご登録内容と一致している必要があります。<br>なお2020年2月3日以前に発行されたパスポートで、最終ページの所持人記入欄に現在のご住所の記載がある場合は、パスポート1点のみで完了します。<br><a href=\"register.html\">→ 会員登録・使い方の詳細</a>",
      keywords: ["パスポート", "パスポートで", "旅券", "所持人記入欄"]
    },
    {
      category: "料金・登録",
      question: "外国籍ですが登録できますか？",
      answer: "ご登録いただけます。パスポートのみでは日本国内のご住所が確認できないため、ご住所を確認できる書類を1点あわせてご提出ください（発行から6ヶ月以内の住民票の写し・公共料金の領収書または請求書・納税証明書など）。中長期滞在の方も住民票が交付されます。<br>あわせて、在留資格が確認できるページ（上陸許可証印またはビザページ）のご提出をお願いしております。在留期限内であることをご確認ください。<br><a href=\"register.html\">→ 会員登録・使い方の詳細</a>",
      keywords: ["外国籍", "外国人", "国籍", "在留", "ビザ", "永住", "パスポート"]
    },
    {
      category: "料金・登録",
      question: "年齢制限はありますか？",
      answer: "利用規約に基づき、18歳以上の方を対象とさせていただいております。18歳未満の方のご登録は無効とさせていただきますので、あらかじめご了承ください。<br><a href=\"terms.html\">→ 利用規約</a>",
      keywords: ["年齢制限", "年齢", "18歳", "未成年", "何歳", "高校生", "中学生"]
    },
    {
      category: "安心・セキュリティ",
      question: "荷物は盗まれませんか？",
    ...
    },
    {
      ...
      answer: "自宅前への放置による留守バレ犯罪リスクを防ぎます。さらに荷物の宛名は本名でなくても配送可能なので、個人情報も守られます。",
      keywords: ["置き配", "留守バレ", "防犯メリット", "宛名"]
    },
    {
      category: "安心・セキュリティ",
      question: "荷物が盗難や破損にあった場合、補償はありますか？",
      answer: "当社に故意または重大な過失がある場合を除き、原則として補償の対象外となります。よっぽどの瑕疵が当社側にあったと考えられる場合は補償対象となることがありますので、状況について下記からお問い合わせください。<br><a href=\"terms.html\">→ 利用規約（責任制限の詳細）</a><br><a href=\"https://page.line.me/301wzhhp?oat__id=6771964&openQrModal=true\" target=\"_blank\" rel=\"noopener\">→ LINEで問い合わせる</a>",
      keywords: ["補償", "保証", "破損", "壊れ", "弁償"]
    },
    {
      category: "安心・セキュリティ",
      question: "スポットで個人情報は他の人に見られませんか？（荷物の宛名について）",
      answer: "荷物の宛名は本名以外での配送も可能で、伝票シールに本人の住所が表示されることもありません。本人確認＋認証デバイスによる解錠のため、第三者が荷物に触れることもできません。<br><a href=\"alias.html\">→ 荷物の宛名設定の詳細ページはこちら</a>",
    ...
    {
      category: "使い方",
      question: "トリイクを通さず、いつものECサイトから直接購入しても大丈夫ですか？",
      answer: "大丈夫です。普段お使いのECサイト・アプリからそのままご購入いただき、お届け先にトリイクスポットをご指定ください。<br><a href=\"ec.html\">→ 楽天市場・Amazon等の入力方法</a>",
      keywords: ["アプリを経由", "アプリ経由", "アプリから買", "直接購入", "直接買", "普通に購入", "トリイクアプリ"]
    },
    {
      category: "使い方",
      question: "伝票の宛名が「EAZY」などで省略されています",
      answer: "宛名が省略された伝票の場合、そのままでは確認ができないことがございます。公式LINEのチャットから、伝票番号とご登録のお名前・電話番号が確認できる画像（ECサイトの注文履歴や配送完了通知など）をあわせてお送りください。確認のうえ承認いたします。<br><a href=\"https://page.line.me/301wzhhp?oat__id=6771964&openQrModal=true\" target=\"_blank\" rel=\"noopener\">→ LINEで問い合わせる</a>",
      keywords: ["eazy", "イージー", "宛名が省略", "宛名省略", "省略", "宛名がない", "宛名がありません", "伝票", "宛名"]
    },
    {
      category: "使い方",
    ...
    },
    {
      category: "使い方",
      question: "伝票とは何ですか？",
      answer: "荷物に貼ってある「荷物伝票（宛名や送り状番号が記載されたシール）」のことです。写真提出の際は、この伝票が写るように撮影してください。",
      keywords: ["伝票とは", "伝票って", "送り状", "シール"]
    },
    {
      category: "使い方",
    ...
    {
      category: "使い方",
      question: "預けられない荷物はありますか？",
      answer: "利用規約でお預かりできない品目を定めております。該当する荷物がスポットに届いた場合、通常の保管をお受けできないため、当日中のお引き取りをお願いすることがございます。<br><a href=\"terms.html\">→ 利用規約（お預かり不可品）</a>",
      keywords: ["預けられない", "預かれない", "お預かりできない", "不可品", "禁止", "送れない", "置けない"]
    },
    {
      category: "使い方",
      question: "どのくらいの期間、預かってもらえますか？",
      answer: "荷物が届いた翌日から7日間が基本の保管期間です。保管期限が切れる前に公式LINEまたはメールでご連絡いただければ、1回のみ・最大7日間の延長が可能です（延長には1日あたり税別500円の追加料金がかかります）。期限を過ぎても受け取りがない場合は、登録住所への着払い発送となるほか、規約違反として違約金（上限10万円・税別）が発生することがあります。<br><a href=\"terms.html\">→ 利用規約（保管期間の詳細）</a>",
    ...
    {
      category: "使い方",
      question: "スポットは施設内のどのあたりにありますか？",
      answer: "各スポットの詳しい場所は、スポット一覧ページの各スポット詳細でご確認いただけます。館内での場所がご不明な場合は、公式LINEのチャットからお問い合わせください。<br><a href=\"spot.html\">→ スポット一覧を見る</a>",
      keywords: ["何階", "階", "館内", "どのあたり", "施設内", "フロア", "スポットは何階", "見つからない"]
    },
    {
      category: "使い方",
    ...
    },
    {
      category: "ポイント",
      question: "ポイントとは？",
      answer: "トリイクスポットで荷物を受け取ると、「トリイクポイント」が貯まります。貯まったポイントは、PayPay・Amazonギフトカード・楽天ポイント・dポイントなど14種類以上のポイント・ギフトに、1ポイント＝1円相当で交換できます。<br><a href=\"point.html\">→ ポイントの詳細はこちら</a>",
      keywords: ["ポイントとは", "トリイクポイントとは", "トリイクポイとは", "トリイクポイ", "ポイントって何"]
    },
    {
      category: "ポイント",
      question: "トリイクポイントは何に交換できるの？",
      answer: "PayPayポイント、Amazonギフトカード、楽天Edy、dポイント、QUOカードPay、銀行振込など14種類以上のポイント・ギフトから選んで、1ポイント＝1円相当で交換できます。交換は外部サービス「デジコ」を通じて行います。<br><a href=\"point.html\">→ 交換できるポイント一覧はこちら</a>",
      keywords: ["何に交換", "交換できる", "paypay", "amazonギフト", "楽天ポイント", "dポイント", "デジコ"]
    },
    {
      category: "ポイント",
    ...
    },
    {
      ...
      answer: "トリイクポイントの有効期限は、当該ポイントを獲得した月を1ヶ月目として起算し、6ヶ月目の月末日までです。<br><a href=\"point.html\">→ ポイントの詳細はこちら</a>",
    ...
    {
      category: "その他",
      question: "会社・法人の配送先として利用できますか？",
      answer: "法人でのご利用については、個別にご相談を承っております。公式LINEのチャットからご連絡ください。担当者より詳細をご案内いたします。<br><a href=\"https://page.line.me/301wzhhp?oat__id=6771964&openQrModal=true\" target=\"_blank\" rel=\"noopener\">→ LINEで問い合わせる</a>",
      keywords: ["法人", "法人契約", "会社", "会社の住所", "会社宛", "企業", "ビジネス", "事業所", "オフィス", "職場"]
    }
  ];
