...
(function () {
  ...
  var FAQ_DATA = [
    ...
    },
    {
      ...
      answer: "自宅前への放置による留守バレ犯罪リスクを防ぎます。さらに仮名でも配送可能なので、個人情報も守られます。",
      keywords: ["置き配", "留守バレ", "防犯メリット", "仮名"]
    },
    {
      category: "安心・セキュリティ",
    ...
    },
    {
      ...
      answer: "荷物には仮名のみ表示され、伝票シールには本名と本人の住所は表示されません。本人確認＋認証デバイスによる解錠のため、第三者が荷物に触れることもできません。<br><a href=\"alias.html\">→ 仮名申請の詳細ページはこちら</a>",
  ...
  var FALLBACK_ANSWER =
    ...
    "お手数ですが、下記からトリイク公式LINEにお問い合わせください。担当者が確認してお答えします。<br>" +
    '<a href="https://lin.ee/TZGo9WHf" target="_blank" rel="noopener">→ 公式LINEに問い合わせる</a>';
  ...
  var BOX_ICON =
    ...
    '<path d="M12 2 L21 6.5 V17.5 L12 22 L3 17.5 V6.5 Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/>' +
    '<path d="M3 6.5 L12 11 L21 6.5" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/>' +
    '<path d="M12 11 V22" stroke="currentColor" stroke-width="1.6"/>' +
    "</svg>";
